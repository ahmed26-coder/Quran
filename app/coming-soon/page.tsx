...
export default function ComingSoon() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-emerald-50 to-white p-4 relative overflow-hidden">
      ...
      <main className="relative z-10 container max-w-5xl mx-auto flex flex-col items-center text-center">
        <h1 className="text-4xl md:text-6xl font-bold text-emerald-800 mb-4 font-arabic">
          بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ
        </h1>

        <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">موقع القرآن الكريم قريباً</h2>
        ...
        <div className="w-full max-w-md mb-12">
          <div className="border border-emerald-200 shadow-md bg-white/80 backdrop-blur-sm rounded-lg p-6">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2 rounded-md border border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition"
                required
              />
              <button
                type="submit"
            ...
            {message && (
              <div className="mt-4 text-green-600 font-semibold">{message}</div> // عرض رسالة النجاح
            )}
          </div>
        </div>
...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
